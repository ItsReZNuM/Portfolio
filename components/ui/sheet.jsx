    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === "right" &&
            "data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right inset-y-0 right-0 h-full w-3/4 sm:max-w-sm border-l border-white/10",
          side === "left" &&
            "data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left inset-y-0 left-0 h-full w-3/4 sm:max-w-sm border-r border-white/10",
          side === "top" &&
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute end-8 top-8 transition-opacity outline-none cursor-pointer">
          <IoMdClose className="text-3xl text-accent hover:rotate-90 transition-transform duration-300" />
